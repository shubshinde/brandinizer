...
Tags: brandinizer,custom info, custom branding, custom dashboard, custom backend, custom branding,shubshinde, fr00sty,froosty, shubham shinde
Donate link: no need
...
Plugins to add Custom Brand Info in WordPress backend.
...
Not at all, wo do not collect your information in any way for in any form. 
...
Your custom branding will be only displayed on dashboard page and login page.
